...
export type { AdminLoginResp, ReviewItem, SensitiveWord, AdminUserItem, PunishAction, AdminPermission, AdminMenuItem, CurrentPerm, AdminRole, AdminAccount, SaveRolePayload, SaveAdminPayload, AdminCategory, SaveCategoryPayload, SavePermissionPayload, ReportItem, HandleReportPayload, AuditLogItem, SystemConfigItem, DataDictItem, BannerItem, DashboardStats, AdminVideoItem } from './apis/admin'
