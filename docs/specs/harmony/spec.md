...
> - 2026-09-22 V1.1：新增 **HMY-05 沉浸光感与品牌氛围**（原 §2.1 只有功能需求，视觉无验收条目；本次按鸿蒙 7 沉浸光感规范补齐，含氛围底与降级口径）
> - 2026-09-22 V1.2：HMY-05 收敛口径——底栏明确为**悬浮玻璃胶囊**、材质赋色明确为**中性系统色（品牌色只留选中态）**、氛围底表述由「品牌粉顶部渐变」改为「极淡品牌粉顶部洗色」（首版品牌粉铺得过重，界面出现"到处是半透明的粉"的割裂感）
...
| HMY-05 | 沉浸光感与品牌氛围 | **THE SYSTEM SHALL** 在支持的设备上以鸿蒙系统沉浸光感材质呈现顶栏、底栏与卡片，**THE SYSTEM SHALL** 将底部标签栏做成悬浮玻璃胶囊（不改造成整宽色条）；**端侧差异**：① 材质赋色**SHALL** 取中性系统色，品牌色**SHALL** 只用于选中态与主按钮；② 材质靠折射背景显形，故**THE SYSTEM SHALL** 在壳层铺设品牌氛围底（**极淡**品牌粉顶部洗色 + 柔和光斑）且页面背景**SHALL NOT** 再盖不透明底色；**IF** 能力不支持 **THEN THE SYSTEM SHALL** 回落为不透明中性底色，**SHALL NOT** 因材质缺失导致内容不可读或控件失去可点区域 | P1 |
